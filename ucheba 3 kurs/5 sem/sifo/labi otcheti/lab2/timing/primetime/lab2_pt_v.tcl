...
read_verilog  lab2.vo
current_design task2
link
...
set_load -pin_load 0 [get_ports { CLK2 } ]
set_load -pin_load 0 [get_ports { Q0 } ]
set_load -pin_load 0 [get_ports { Q1 } ]
set_load -pin_load 0 [get_ports { Q2 } ]
set_load -pin_load 0 [get_ports { Q3 } ]
set_load -pin_load 0 [get_ports { res[0] } ]
set_load -pin_load 0 [get_ports { res[10] } ]
set_load -pin_load 0 [get_ports { res[11] } ]
set_load -pin_load 0 [get_ports { res[12] } ]
set_load -pin_load 0 [get_ports { res[13] } ]
set_load -pin_load 0 [get_ports { res[14] } ]
set_load -pin_load 0 [get_ports { res[15] } ]
set_load -pin_load 0 [get_ports { res[1] } ]
set_load -pin_load 0 [get_ports { res[2] } ]
set_load -pin_load 0 [get_ports { res[3] } ]
set_load -pin_load 0 [get_ports { res[4] } ]
set_load -pin_load 0 [get_ports { res[5] } ]
set_load -pin_load 0 [get_ports { res[6] } ]
set_load -pin_load 0 [get_ports { res[7] } ]
set_load -pin_load 0 [get_ports { res[8] } ]
set_load -pin_load 0 [get_ports { res[9] } ]
