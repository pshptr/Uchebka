...
int main()
{
    ...
    for(int i = 0; i < 3; i++)
    {
        printf("%s/n", employee_data[i].surname);
        printf("%s/n", employee_data[i].name);
        printf("%s/n", employee_data[i].patronymic);

        printf("%s/n", employee_data[i].employee_date);

        printf("%lf/n", employee_data[i].salary); 
